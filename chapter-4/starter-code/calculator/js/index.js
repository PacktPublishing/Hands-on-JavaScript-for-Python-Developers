  ...
  const clickHandler = ((event) => {
    ...
    /** Write your calculator logic here.
        ...
        Expected things to use:
          eval() - this is new and should be used sparingly. https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/eval
          isNan() - also new. https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/isNaN
          parseFloat()
          parseInt()
